...
local source_mapping = {
  ...
  Copilot = xotovim.icons.copilot,
  Codeium = xotovim.icons.codeium,
  nvim_lsp = xotovim.icons.paragraph .. "LSP",
  buffer = xotovim.icons.buffer .. "BUF",
  nvim_lua = xotovim.icons.bomb,
  luasnip = xotovim.icons.snippet .. "SNP",
  calc = xotovim.icons.calculator,
...
cmp.setup({
  ...
  mapping = cmp.mapping.preset.insert({
    ...
    ["<CR>"] = cmp.mapping.confirm({
			...
			select = xotovim.plugins.completion.select_first_on_enter,
		}),
    -- ['<CR>'] = cmp.mapping.confirm({ select = xotovim.plugins.completion.select_first_on_enter, behavior = cmp.ConfirmBehavior.Replace }),
