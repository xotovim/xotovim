...
vim.api.nvim_create_autocmd("FileType", { pattern = "*", callback = function() if XotoVimGlobal.plugins.zen.enabled and vim.bo.filetype ~= "alpha" then pwk.attach_zen(0) end end })
...
autocmd({ 'ModeChanged' }, {
  callback = function()
    ...
    if current_mode == 'n' then
      vim.api.nvim_set_hl(0, 'SmoothCursor', { fg = '#34384f' })
