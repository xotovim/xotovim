...
},
{
	...
	-- LSP Cmp
	{
		...
		dependencies = {
			...
			{
				cond = xotovim.plugins.ai.tabnine.enabled,
				"tzachar/cmp-tabnine",
				build = "./install.sh",
			},
			{
			...
			},
			{
				...
				cond = xotovim.plugins.ai.copilot.enabled,
				config = function()
	...
	},
	{
		...
		cond = xotovim.plugins.zen.enabled,
	},
	{
		"folke/twilight.nvim",
		config = true,
	...
	},
	{
		"airblade/vim-rooter",
		setup = function()
			vim.g.rooter_patterns = xotovim.plugins.rooter.patterns
		end,
	},
	{
	...
	-- {
	-- 	"folke/noice.nvim",
	-- 	cond = xotovim.plugins.experimental_noice.enabled,
	-- 	lazy = false,
	-- 	config = function()
	...
	-- },
	{
		...
		cond = xotovim.plugins.jump_by_subwords.enabled,
		lazy = true,
		keys = { "w", "e", "b", "ge" },
		config = function()
	...
	-- AI
	{
		...
		cond = xotovim.plugins.ai.codeium.enabled,
		event = "InsertEnter",
		cmd = "Codeium",
		dependencies = {
			"nvim-lua/plenary.nvim",
	...
	{
		"Bryley/neoai.nvim",
		cond = xotovim.plugins.ai.chatgpt.enabled,
		dependencies = {
