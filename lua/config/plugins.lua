return {
	...
	{ "nvim-lualine/lualine.nvim", lazy = false, priority = 1000, config = function() require("plugins.lualine") end, event = { "VimEnter", "InsertEnter", "BufReadPre", "BufAdd", "BufNew", "BufReadPost" } },
	...
	{ "antosha417/nvim-lsp-file-operations", event = "LspAttach", dependencies = { { "nvim-lua/plenary.nvim" }, { "nvim-tree/nvim-tree.lua" }, }, },
	...
	{ 'nvim-telescope/telescope-ui-select.nvim', lazy = false, event = "BufReadPre" }, 
	{ 'rmagatti/goto-preview', lazy = true, event = "VeryLazy", config = function() require("plugins.preview") end }, 
	{ "https://git.sr.ht/~whynothugo/lsp_lines.nvim", lazy = false, config = function() require("lsp_lines").setup() end },
	...
	{ "sindrets/diffview.nvim", lazy = true, enabled = true, event = "BufRead", config = function() require("plugins.git.diffview") end },
