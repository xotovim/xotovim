local ts = require("xotonight.treesitter")
...
function M.invert_color(color)
  local hsluv = require("xotonight.hsluv")
  if color ~= "NONE" then
...
function M.onColorScheme()
  vim.cmd([[autocmd! XotoNight]])
  vim.cmd([[augroup! XotoNight]])
end
...
function M.autocmds(config)
  vim.cmd([[augroup XotoNight]])
  vim.cmd([[  autocmd!]])
  vim.cmd([[  autocmd ColorSchemePre * lua require("xotonight.util").onColorScheme()]])
